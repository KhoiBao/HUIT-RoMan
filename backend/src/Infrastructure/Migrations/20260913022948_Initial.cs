    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsageConditions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultPenalty = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomTypes_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RestrictionType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "RoomTypeConditions",
                columns: table => new
                {
                    RoomTypeId = table.Column<int>(type: "integer", nullable: false),
                    UsageConditionId = table.Column<int>(type: "integer", nullable: false),
                    Value = table.Column<string>(type: "text", nullable: false),
                    IsRequired = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomTypeConditions", x => new { x.RoomTypeId, x.UsageConditionId });
                    table.ForeignKey(
                        name: "FK_RoomTypeConditions_RoomTypes_RoomTypeId",
                        column: x => x.RoomTypeId,
                        principalTable: "RoomTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomTypeConditions_UsageConditions_UsageConditionId",
                        column: x => x.UsageConditionId,
                        principalTable: "UsageConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsageSessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsageSessions_BookingDetails_BookingDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentConditionLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EquipmentConditionLogs_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EquipmentConditionLogs_UsageSessions_UsageSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_UsageSessions_UsageSessionId",
                        column: x => x.UsageSessionId,
                        principalTable: "UsageSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: false),
                    Severity = table.Column<int>(type: "integer", nullable: false),
                    PenaltyApplied = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    UsageSessionId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ViolationRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ViolationRecords_UsageSessions_UsageSessionId",
                        column: x => x.UsageSessionId,
                        principalTable: "UsageSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ViolationRecords_ViolationTypes_ViolationTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentConditionLogs_EquipmentId",
                table: "EquipmentConditionLogs",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_EquipmentConditionLogs_UsageSessionId",
                table: "EquipmentConditionLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_UsageSessionId",
                table: "Feedbacks",
                column: "UsageSessionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeConditions_UsageConditionId",
                table: "RoomTypeConditions",
                column: "UsageConditionId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomTypes_DepartmentId",
                table: "RoomTypes",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageSessions_BookingDetailId",
                table: "UsageSessions",
                column: "BookingDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_UsageSessions_UserId",
                table: "UsageSessions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViolationRecords_UsageSessionId",
                table: "ViolationRecords",
                column: "UsageSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_ViolationRecords_UserId",
                table: "ViolationRecords",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ViolationRecords_ViolationTypeId",
                table: "ViolationRecords",
